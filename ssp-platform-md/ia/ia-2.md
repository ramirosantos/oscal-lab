...
x-trestle-comp-def-rules:
  Kubernetes Control Plane:
    - name: api-anonymous-off
      description: Anonymer Zugriff ist auf die Health-Endpunkte /healthz, 
        /livez und /readyz beschraenkt
x-trestle-global:
  profile:
...
Menschliche Nutzer authentisieren sich per X.509-Client-Zertifikat aus der kubeconfig, technische Identitaeten per ServiceAccount-Token. MFA und eine OIDC-Anbindung sind im Lab NICHT umgesetzt und als POA&M-Item gefuehrt.

#### Implementation Status: implemented

### Kubernetes Control Plane

Anonymer Zugriff ist auf drei Health-Endpunkte beschraenkt; jeder andere Zugriff erfordert Authentifizierung.

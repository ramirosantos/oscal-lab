...
x-trestle-comp-def-rules:
  Calico CNI:
    - name: net-default-deny
      description: Default-Deny NetworkPolicy fuer Ingress und Egress je 
        Workload-Namespace
...
Boundary Protection erfolgt ausschliesslich durch Calico-NetworkPolicies je Namespace. Das Lab-Netz ist flach; es gibt keine Netzsegmentierung, auf die man sich zusaetzlich stuetzen koennte.

#### Implementation Status: implemented

### Calico CNI

Boundary Protection durch Namespace-bezogene NetworkPolicies.

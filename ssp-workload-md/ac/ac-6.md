...
Least Privilege gilt fuer Workloads (Non-Root, keine Capabilities, kein Privilege-Escalation). Fuer menschliche Zugriffe gilt es im Lab NICHT: die minikube-kubeconfig gehoert zur Gruppe system:masters. Diese Abweichung ist bekannt und als POA&M-Item erfasst.
